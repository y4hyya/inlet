...
For a protocol's own deposit page there is also a button. It sits beside the native control, opens the same form for that one destination in a dialog, and keeps a small status pill beside itself until the deposit or withdrawal lands, see [inletkit.vercel.app/embed](https://inletkit.vercel.app/embed).
