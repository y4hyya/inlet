...
The hub and every receiver were redeployed on 2026-09-18 so that only a receiver can consume the hub's message and nothing but a message Circle attested can drive an adapter. Runs recorded before that date point at the previous addresses; the first deposit through the new contracts is in [`services/relayer/README.md`](services/relayer/README.md).
...
On the hosted stack a Gateway deposit takes about twenty seconds, a CCTP deposit thirty to forty five, a deposit driven by the MCP server sixteen, and a deposit from Solana Devnet twenty nine: [burn on Solana](https://explorer.solana.com/tx/2iL8RNpRveC99CZNTqZ2Zns6VGrHu9UX6ppbEA8gMcArw96myx8Lie4KGpHxcE9z9YGZ3GUyRtQwwMzN1Li733tb?cluster=devnet), [mint on Arc](https://testnet.arcscan.app/tx/0x1574b0544f468695056263d2edec930a45cf97fe76884fab6a36190626a6357a), [sweep](https://testnet.arcscan.app/tx/0xe63f0e973034e710e1c553d51d00b6dde600e6f2f3a9dc2daf957f8254136b7f), [execute on Base Sepolia](https://sepolia.basescan.org/tx/0xbbc031bfd2ae5aac49de82f973ba7db83079db4615b90b975779c068f83ea3be). Every run with all of its transaction hashes is in [`services/relayer/README.md`](services/relayer/README.md).
