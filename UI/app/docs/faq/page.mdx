...
Sources: any chain with Gateway or CCTP V2 and USDC, with Base Sepolia and Arbitrum Sepolia configured in the widget. Destinations: Arbitrum Sepolia, Base Sepolia and Unichain Sepolia, where receivers are deployed. Adding a destination chain means deploying a receiver and registering its domain on the hub.
