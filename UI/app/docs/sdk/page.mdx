...
The relayer's `scripts/e2e.ts` and `scripts/e2e-gateway.ts` are complete, runnable versions of both routes, and every recorded run on the [start page](/#destinations) came out of them.
