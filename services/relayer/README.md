...
| CCTP from Solana Devnet into Compound III on Base Sepolia, one depositForBurn on Circle's Solana program signed by a devnet wallet and driven by `pnpm e2e:solana` against the hosted relayer | 2iL8RNpRveC99CZNTqZ2Zns6VGrHu9UX6ppbEA8gMcArw96myx8Lie4KGpHxcE9z9YGZ3GUyRtQwwMzN1Li733tb | 0x1574b0544f468695056263d2edec930a45cf97fe76884fab6a36190626a6357a | 0xe63f0e973034e710e1c553d51d00b6dde600e6f2f3a9dc2daf957f8254136b7f | 0xbbc031bfd2ae5aac49de82f973ba7db83079db4615b90b975779c068f83ea3be | 29 seconds |
...
| Direct CCTP from Base Sepolia into the demo vault on Arbitrum Sepolia, the first deposit through the hub and receivers redeployed on 2026-09-18, where the hub names the receiver as the destination caller and the receiver mints and executes in one `receiveAndExecute` call, local relayer, 999870 shares | 0x24ad97de967fcc7f2ccebb69ced989a1d26c174acca83b8f763f1c93675e12b7 | 0xc0eebdf69c394f54ec2effdc0a75591543ae47ee991277f119a2f1586481899c | 0xf7dab0283ace423c66bce3dea09b90ca8b5573e8291adb8ba03b17cc6955aca4 | 0x11a6c656fa9d119f21c65239358aa41aa6e4920950cc8784f202074d509c9571 | 35 seconds |
...
| 0.5 aArbSepUSDC out of Aave V3 on Arbitrum Sepolia, driven by the MCP server's withdraw tool against the hosted relayer | 0.2 USDC to Base Sepolia, the rest to Arc | 0xb60bada0e5ec61a5d1f5b3e685812690a03f6d32e9b94d8b6aa4a4d3526c2338 | 0x7a83ed9a3b1893f34a47bc5077442df6a69c7cd9b10139910ade2465b78ed4e3, executor 0x6094578902C8B67a96a3F31Adab0C85BFb69D0F6 | Base Sepolia 0x3af9abc6a8b772c0ef4d1f07ff1129dac2f3e011bdf46eb40b0b2bc377d38e44, Arc 0xae80bc05eca48ba10482eb23eb7472c10c3cbf9db21d02be3054d47aecec5f01 | 17 seconds |
| 2 aArbSepUSDC out of Aave V3 on Arbitrum Sepolia, one permit signed in the widget from a browser wallet, hosted relayer | everything to Monad Testnet | 0xb21b5cc488f1e3bb2894aadeabeb9edbfce1223ee141280b07063a28a684ebd3 | 0x4c8b160080b18cf8eadd315a20f84facee8b86f2ce79eec66c7b34c88b29466c, executor 0xfbaa16F1C7787D0E7e22d09ecFd34DB635Ab7F25 | Monad Testnet 0x12d1b4ddd6bedafb90ab23253c70ca3d2b753f189475ba93f9b0e44c55d291a7 for 1999741 | 13 seconds from the signature reaching the relayer to the mint on Monad |
